...
Currently pursuing a Master’s degree in Bioengineering, working within the ECL ([Empathic Computing Lab](https://empathiccomputing.org/)).  Focusing on understanding and improving remote rehabilitation for traumatic brain injury patients using multi-user virtual reality. This work involves strong C# development within the Unity game engine, along with applied clinical design principles and data analysis.
